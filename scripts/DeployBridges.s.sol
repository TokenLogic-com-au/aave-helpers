...
import {ArbitrumScript, EthereumScript, OptimismScript, PolygonScript, BaseScript} from 'solidity-utils/contracts/utils/ScriptUtils.sol';
...
contract DeployBaseBridgeBase is BaseScript {
  function run() external broadcast {
    bytes32 salt = 'Aave Treasury Bridge';
    new AaveBaseEthERC20Bridge{salt: salt}(0x94A8518B76A3c45F5387B521695024379d43d715);
  }
}
